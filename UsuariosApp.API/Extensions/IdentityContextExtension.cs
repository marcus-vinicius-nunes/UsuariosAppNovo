...
namespace UsuariosApp.API.Extensions
{
    ...
    public static class IdentityContextExtension
    {
        ...
        {
            //configurando os parametros do /appsetings
            ...
            services.AddDbContext<IdentityContext>(options => options.UseSqlServer(configuration.GetConnectionString("BDUsuariosApp")));
